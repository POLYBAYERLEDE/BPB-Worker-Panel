...
let userID = '71b74562-4197-4adb-b08f-a04e673d194d';
...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `💦 WANG - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `💦 WANG - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `💦 WANG - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `💦 WANG - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = '💦 WANG Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = '💦 WANG Frag - Best Ping 💥';
    ...
    bestFragment.remarks = '💦 WANG Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = '💦 WANG - Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `💦 WANG - WoW ${index/2 + 1} 🌍`;
